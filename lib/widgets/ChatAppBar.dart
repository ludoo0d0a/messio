              ...
              child: Container(
                  ...
                  child: Row(children: <Widget>[
                                    ...
                                    Expanded(
                                        ...
                                        child: Container(
                                          ...
                                          return Column(
                                            ...
                                            mainAxisSize: MainAxisSize.min,
                                            children: <Widget>[
                                              Text(_name, style: Styles.textHeading),
                                      ...
                                      children: <Widget>[
                                        GestureDetector(
                                          ...
                                          onTap: () => Navigator.push(context,
                                              SlideLeftRoute(page: AttachmentPage(this.chat.chatId, FileType.IMAGE))),
                                        ),
                                        VerticalDivider(
                                          width: 30,
                                        ...
                                        GestureDetector(
                                          ...
                                          onTap: () => Navigator.push(context,
                                              SlideLeftRoute(page: AttachmentPage(this.chat.chatId, FileType.VIDEO))),
                                        ),
                                        VerticalDivider(
                                          width: 30,
                                          color: Palette.primaryTextColor,
                                        ...
                                        GestureDetector(
                                          ...
                                          onTap: () => Navigator.push(context,
                                              SlideLeftRoute(page: AttachmentPage(this.chat.chatId, FileType.ANY))),
                                        )
                                      ],
                                    ))),
                          ],
                    ...
                    Expanded(
                        flex: 3,
                        child:
                            Container(child: Center(child: BlocBuilder<ChatBloc, ChatState>(builder: (context, state) {
                          return CircleAvatar(
                            radius: 30,
